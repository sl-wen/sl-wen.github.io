            ...
            {[
              ...
              <button
                ...
                className={`w-full p-2 text-left rounded ${
                  tool === toolOption.key ? 'bg-blue-500 text-white' : 'bg-gray-200'
                }`}
            ...
            {TILE_DEFINITIONS.map((tile) => (
              <button
                ...
                className={`p-3 rounded border-2 text-center ${
                  selectedTileId === tile.id ? 'border-blue-500 bg-blue-50' : 'border-gray-300'
                }`}
        ...
        <div className="space-y-2">
          ...
          <label className="block">
            <input
              ...
              className="hidden"
            />
            <span className="w-full p-2 bg-blue-500 text-white rounded hover:bg-blue-600 cursor-pointer block text-center">
              📁 加载地图
            </span>
          </label>
