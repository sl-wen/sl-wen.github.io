...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _supabase_config_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./supabase-config.js */ \"./static/js/supabase-config.js\");\n\n\n\n\n// 格式化日期\nfunction formatDate(timestamp) {\n  var date = new Date(timestamp);\n  return date.toLocaleDateString('zh-CN', {\n    year: 'numeric',\n    month: '2-digit',\n    day: '2-digit'\n  });\n}\n\n// 获取文章分类\nfunction getCategories() {\n  return _getCategories.apply(this, arguments);\n} // 页面加载完成后执行\nfunction _getCategories() {\n  _getCategories = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__.mark(function _callee() {\n    var container, statusDiv, _yield$supabase$from$, posts, error, categorizedPosts, categoriesHtml, categories;\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__.wrap(function _callee$(_context) {\n      while (1) switch (_context.prev = _context.next) {\n        case 0:\n          container = document.getElementById('categories-container');\n          statusDiv = document.getElementById('status-messages');\n          _context.prev = 2;\n          if (statusDiv) {\n            statusDiv.innerHTML += '<p>开始从 Supabase 获取文章数据...</p>';\n          }\n\n          // 获取所有文章\n          _context.next = 6;\n          return _supabase_config_js__WEBPACK_IMPORTED_MODULE_2__.supabase.from('posts').select('*').order('created_at', {\n            ascending: false\n          });\n        case 6:\n          _yield$supabase$from$ = _context.sent;\n          posts = _yield$supabase$from$.data;\n          error = _yield$supabase$from$.error;\n          if (!error) {\n            _context.next = 11;\n            break;\n          }\n          throw error;\n        case 11:\n          if (statusDiv) {\n            statusDiv.innerHTML += \"<p>\\u67E5\\u8BE2\\u5B8C\\u6210\\uFF0C\\u627E\\u5230 \".concat(posts.length, \" \\u7BC7\\u6587\\u7AE0</p>\");\n          }\n          if (!(!posts || posts.length === 0)) {\n            _context.next = 15;\n            break;\n          }\n          container.innerHTML = '<div class=\"no-posts\">暂无文章，请先<a href=\"/pages/post.html\">发布一篇文章</a></div>';\n          return _context.abrupt(\"return\");\n        case 15:\n          // 按标签分组文章\n          categorizedPosts = {};\n          posts.forEach(function (post) {\n            var tags = post.tags || ['未分类'];\n            tags.forEach(function (tag) {\n              if (!categorizedPosts[tag]) {\n                categorizedPosts[tag] = [];\n              }\n              categorizedPosts[tag].push({\n                id: post.id,\n                title: post.title || '无标题',\n                created_at: post.created_at,\n                views: post.views || 0\n              });\n            });\n          });\n\n          // 显示分类\n          categoriesHtml = ''; // 按分类名称排序\n          categories = Object.keys(categorizedPosts).sort();\n          categories.forEach(function (category) {\n            var posts = categorizedPosts[category];\n            categoriesHtml += \"\\n                <div class=\\\"category-list\\\">\\n                    <h2 class=\\\"category-name\\\">\".concat(category, \"</h2>\\n                    <ul class=\\\"post-list\\\">\\n            \");\n            posts.forEach(function (post) {\n              var date = post.created_at ? formatDate(post.created_at) : '未知日期';\n              categoriesHtml += \"\\n                    <li>\\n                        <span class=\\\"post-date\\\">\".concat(date, \"</span>\\n                        <a href=\\\"/pages/article.html?id=\").concat(post.id, \"\\\">\").concat(post.title, \"</a>\\n                        <span class=\\\"post-views\\\">\\uD83D\\uDC41\\uFE0F\\u200D\\uD83D\\uDDE8\\uFE0F \").concat(post.views, \"</span>\\n                    </li>\\n                \");\n            });\n            categoriesHtml += \"\\n                    </ul>\\n                </div>\\n            \";\n          });\n          container.innerHTML = categoriesHtml;\n          if (statusDiv) {\n            statusDiv.innerHTML += '<p>分类渲染完成</p>';\n          }\n          _context.next = 29;\n          break;\n        case 24:\n          _context.prev = 24;\n          _context.t0 = _context[\"catch\"](2);\n          console.error('获取分类失败:', _context.t0);\n          container.innerHTML = \"<div class=\\\"error\\\">\\u52A0\\u8F7D\\u5206\\u7C7B\\u5931\\u8D25: \".concat(_context.t0.message, \"</div>\");\n          if (statusDiv) {\n            statusDiv.innerHTML += \"\\n                <p style=\\\"color: red;\\\">\\u9519\\u8BEF: \".concat(_context.t0.message, \"</p>\\n                <p>\\u9519\\u8BEF\\u8BE6\\u60C5: \").concat(JSON.stringify(_context.t0), \"</p>\\n            \");\n          }\n        case 29:\n        case \"end\":\n          return _context.stop();\n      }\n    }, _callee, null, [[2, 24]]);\n  }));\n  return _getCategories.apply(this, arguments);\n}\ndocument.addEventListener('DOMContentLoaded', getCategories);\n\n//# sourceURL=webpack://sl-wen-blog/./static/js/categories.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./static/js/categories.js");
/******/ 	
